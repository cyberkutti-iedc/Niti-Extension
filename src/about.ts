...
export function showAboutPage() {
    const panel = vscode.window.createWebviewPanel(
        'aboutPage', // Identifies the type of the webview. Used internally
    ...
    const logoUri = panel.webview.asWebviewUri(vscode.Uri.file(path.join(__dirname, 'images', 'logo.jpg')));
